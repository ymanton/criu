...
fedora-non-root() {
	...
	# under those conditions. Note that the "... && true" part is necessary; we need bash to execute at least one statement after the tests so that it will reap zombies in the user namespace.
